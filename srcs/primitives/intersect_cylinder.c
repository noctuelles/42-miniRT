...
/*   Updated: 2022/08/10 13:25:01 by plouvel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static inline void
	intersect_cylinder_endcap(t_ray lray, double *endcap_t)
{
	double	t[2];
	double	inter_t[2];
...
static inline void
	intersect_cylinder_body(t_ray lray, double *body_t)
{
	double	t[2];
	double	valid_t[2];
	double	y[2];

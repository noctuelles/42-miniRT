...
/*   Updated: 2022/08/11 16:35:51 by bsavinel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_object	*new_cylinder(t_point3 pos, double diameter, double height,
				t_vec3 orientation, uint32_t color);
t_object	*new_cone(t_point3 pos, double diameter, double height,
